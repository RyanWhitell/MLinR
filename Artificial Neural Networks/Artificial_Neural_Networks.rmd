...
The output of the ANN is not binary, so round the outputs to get the binary classification.
```{r}
...
There are many neural network hyperparameters or 'knobs' to try tweaking to get better accuracy. The SVM [LINK] classified this data set with 100% accuracy, so the neural network should be able to do the same.
